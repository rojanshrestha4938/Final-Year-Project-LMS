...
const SinglePurchasedCourse = () => {
    ...
    const getQuizHandler = (quizData) => {
        const quizId = typeof quizData === 'object' && quizData !== null ? quizData._id : quizData
        if (quizId) {
    ...
    const createQuizHandler = (moduleData) => {
        setGeneratingQuizModuleId(moduleData._id)
        createQuiz(
            {
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-[calc(100vh-12vh)] bg-slate-50">
            {/* Left - Video & Comments */}
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            {!item.quiz ? (
                                                <button
                                                    ...
                                                    disabled={generatingQuizModuleId === item._id}
                                                    className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-lg transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
                                                    {generatingQuizModuleId === item._id ? (
                                                        <>

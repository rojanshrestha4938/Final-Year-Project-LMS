        ...
        {showResult ? (
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 mb-6">
              ...
              <h1 className="text-3xl font-black text-slate-900">{data?.quiz?.moduleId?.title || data?.quiz?.content || 'Quiz'}</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                <button
                  ...
                  className={`w-full py-4 rounded-xl font-bold text-white text-lg transition-all ${answeredCount < totalQuestions
